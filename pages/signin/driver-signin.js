...
const DriverSignin = () => {
  const level = useSelector((state) => state.scud.driversigninlevel);
  ...
  return (
    <div
      ...
      } pb-12 md:pb-0 bg-[#fbfbff]  md:bg-none bg-[url('/sign.png')] bg-50% bg-no-repeat  bg-left-bottom `}
    >
      {/* <img className="h-24 w-40" src="/sign.png" /> */}
      <div className=" flex flex-col space-y-4 lg:items-start md:space-y-0 lg:flex-row px-5 lg:justify-start  lg:px-20 md:pt-8 w-full lg:space-x-8 ">
        ...
        <div className="md:w-[47%] flex flex-col justify-center items-center">
          ...
          {level === 1 ? <SignupForm signin={true} /> : <SignUpOtpForm signin={true} />}
        </div>
        {/* <img className="h-24 w-60" src="/sign.png" /> */}
      </div>
