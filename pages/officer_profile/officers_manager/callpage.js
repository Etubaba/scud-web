...
const Callpage = () => {
  ...
  return (
    <div>
      <div
        onClick={() => router.push("/officer_profile/officers_manager/support")}
        className="flex cursor-pointer hover:text-textColor/30 mb-12 space-x-2 items-center"
      >
        <div className="bg-[#CCD6FF]/50 hover:bg-[#ccd6ff]/40 rounded-md p-1 ">
          <IoIosArrowBack className="text-textColor" />
        </div>
        <p className=" text-textColor hover:text-gray-400 text-sm tracking-wide">
          Back
        </p>
      </div>
