    ...
    <div>
      ...
      <div className="flex w-full md:hidden space-x-6 h-full ">
        {activechat == null ? (
          ...
          <div className="border rounded-md  w-full md:w-3/5   max-h-[1200px]  flex flex-col justify-center items-center">
            ...
            {/* chat box ################################## */}
            <div className="w-full max-h-[20rem] px-4  overflow-y-scroll">
              <div className="mb-20">
                {/* chat section ################################################################## */}
            ...
            <div className="flex  justify-center items-center h-12 px-3 md:px-0  w-full bg-white border-t">
      ...
      <div className="hidden md:block">
        <div className="flex w-full space-x-6 h-full ">
          ...
          {activechat !== null ? (
            <div className="border rounded-md w-full md:w-3/5    max-h-[1000px]  flex flex-col justify-center items-center">
              <div className="flex   self-start justify-start  px-3 md:px-0 md:left-auto  w-full bg-white border-b">
                <div className="flex  justify-between items-center w-full">
              ...
              <div className="flex justify-center items-center h-14   w-full bg-white border-t">
